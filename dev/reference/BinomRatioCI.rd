...
and the Noether (1957) procedure. Koopman results are found iteratively for most intervals using root finding."><meta name="robots" content="noindex"><!-- mathjax --><script src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js" integrity="sha256-nvJJv9wWKEm88qvoQl9ekL2J+k/RWIsaSScxxlsrv8k=" crossorigin="anonymous"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/config/TeX-AMS-MML_HTMLorMML.js" integrity="sha256-84DKXVJXs0/F8OTMzX4UR909+jtl4G7SPypPavF+GfA=" crossorigin="anonymous"></script><!--[if lt IE 9]>
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <span class="navbar-brand">
        ...
        <span class="version label label-danger" data-toggle="tooltip" data-placement="bottom" title="In-development version">0.99.54.10</span>
      </span>
    </div>
...
<table class="table table"><tr><td>Method</td><td>Algorithm</td></tr><tr><td></td><td></td></tr><tr><td><!-- % Katz-log	 -->
Katz-log</td><td>\(\hat\theta_i\times\) exp\((\pm z_1-\alpha/2\hat{\sigma}_W)\),</td></tr><tr><td></td><td>where \(\hat\sigma_W^2=\frac{(1-\hat{\pi} _{1i})}{\hat{\pi}_{1i}n_1}+\frac{(1-\hat{\pi}_{2i})}{\hat{\pi}_{2i}n_2}\).</td></tr><tr><td></td><td></td></tr><tr><td><!-- % Adjusted log -->
Adjusted-log</td><td>\(\hat{\theta}_{Ai}\times\) exp\((\pm z_1-\alpha /2\hat{\sigma}_A)\),</td></tr><tr><td></td><td>where \(\hat{\theta}_{Ai}=\frac{y_{1i}+0.5/n_1+0.5}{y_{2i}+0.5/n_2+0.5}\),</td></tr><tr><td></td><td>\(\hat{\sigma}_A^2=\frac{1}{y_1+0.5}-\frac{1}{n_1+0.5}+\frac{1}{y_2+0.5}-\frac{1}{n_2+0.5}\).</td></tr><tr><td></td><td></td></tr><tr><td><!-- % Bailey -->
